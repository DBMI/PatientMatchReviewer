...
class Wobbler():
    ...
    def read_wobbler_file(match_file: str, log: logging.Logger) -> pandas.DataFrame:
        ...
        column_names: list = ["ADDR1_AOU", "ADDR1_OMOP", "ADDR1_SCORE",
                              "DOB_AOU", "DOB_OMOP", "DOB_SCORE",
                              "FAMILY_NAME_AOU", "FAMILY_NAME_OMOP", "FAMILY_NAME_SCORE",
                              "GIVEN_NAME_AOU", "GIVEN_NAME_OMOP", "GIVEN_NAME_SCORE",
                              "MATCH", "MRN", "OMOP_ID",
                              "PHONE1_AOU", "PHONE1_OMOP", "PHONE1_SCORE",
                              "PHONE2_AOU", "PHONE2_OMOP", "PHONE2_SCORE",
                              "PMI_ID", "TOTAL_SCORE"]
        data_rows: list = []
                ...
                for line in file:
                    ...
                    if line.startswith(sep):
                        ...
                        if in_record:
                            ...
                            new_row: list = [addr1_aou, addr1_omop, addr1_score,
                                             dob_aou, dob_omop, dob_score,
                                             family_name_aou, family_name_omop, family_name_score,
                                             given_name_aou, given_name_omop, given_name_score,
                                             match, mrn, omop_id,
                        ...
                        match: MatchDecision = MatchDecision.UNSURE
                        mrn: str = ""
                        omop_id: str = ""
                        phone1_aou: str = ""
                        phone1_omop: str = ""
                    ...
                    # CAUTION: Don't believe automated hint that this "?:" is unnecessary.
                    ...
                    match len(tokens):
                        ...
                        case 1:
                            ...
                            if "NO MATCH" in token0 and any(mark in line for mark in decision_marks):
                                match = MatchDecision.NO_MATCH
                            elif "MATCH" in token0 and any(mark in line for mark in decision_marks):
